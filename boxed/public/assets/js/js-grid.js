(function($) {
  'use strict';
  $(function() {
    $('.jsgrid-align-right').removeClass('jsgrid-align-right');
    //basic config
    if ($("#js-grid").length) {
      $("#js-grid").jsGrid({
        height: "500px",
        ...
        fields: [{
          ...
          },
          {
            ...
            //   return $('<select>').addClass('form-select').attr('data-value', value)
            //   .append($.map(this.items, function(option) {
            //     return $("<option>").attr("value", option.Value)
