(function($) {
  ...
  $(function() {
    $('#show').avgrund({
      ...
      template: '<p class="text-dark">So implement your design and place content here! If you want to close modal, please hit "Esc", click somewhere on the screen or use special button.</p>' +
